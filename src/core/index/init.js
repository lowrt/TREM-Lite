...
document.getElementById("eew_max_intensity").textContent = get_lang_string("eew.max.intensity");
document.getElementById("max_intensity_text").textContent = get_lang_string("rts.max.intensity");
document.getElementById("max_pga_text").textContent = get_lang_string("rts.max.pga");
